...
describe('Container config list', () => {
  it('should return 200 on successful list', async () => {
    service.findAll.mockResolvedValue([{ container_key: 'test', name: 'test' }]);
...
describe('Container config insert', () => {
  it('should return 200 on successful insert', async () => {
    service.insert.mockResolvedValue({ container_key: 'test', name: 'test' });

    mockSession.setSession({ user: { username: 'admin', admin: true } });

    const res = await request(app).post('/container-config').send({ container_key: 'test', name: 'test' });
  ...
  it('should return 400 if container_key is missing', async () => {
    ...
    const res = await request(app).post('/container-config').send({ name: 'test' });
  ...
  it('should return 400 if name is missing', async () => {
    ...
    const res = await request(app).post('/container-config').send({ container_key: 'test' });
...
describe('Container config update', () => {
  it('should return 200 on successful update', async () => {
    service.update.mockResolvedValue({ container_key: 'test', name: 'test' });

    mockSession.setSession({ user: { username: 'admin', admin: true } });

    const res = await request(app).put('/container-config').send({ container_key: 'test', name: 'test' });
  ...
  it('should return 400 if container_key is missing', async () => {
    ...
    const res = await request(app).put('/container-config').send({ name: 'test' });
  ...
  it('should return 400 if name is missing', async () => {
    ...
    const res = await request(app).put('/container-config').send({ container_key: 'test' });
...
describe('Container config delete', () => {
  it('should return 200 on successful delete', async () => {
    service.deleteContainer.mockResolvedValue({ container_key: 'test', name: 'test' });
